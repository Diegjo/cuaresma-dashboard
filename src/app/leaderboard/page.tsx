...
export default function LeaderboardPage() {
  ...
  useEffect(() => {
    ...
    setUser(currentUser);
    setLeaderboard(getLeaderboard([...CONFIG.participants]));
  }, [router]);
        ...
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">
              {CONFIG.participants.length} participantes
            </p>
          </div>
          ...
          <div className="flex items-end justify-center gap-2 mb-6 pt-4">
            ...
            <div className="flex flex-col items-center -mt-4">
              ...
              <div className="bg-violet-600 rounded-xl border border-violet-600 p-4 w-28 text-center text-white">
                ...
                <div className="text-2xl font-bold">{leaderboard[0].totalPoints}</div>
