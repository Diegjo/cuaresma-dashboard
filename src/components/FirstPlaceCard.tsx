...
export function FirstPlaceCard({ entry }: { entry: LeaderboardEntry }) {
  return (
    <div className="rounded-3xl bg-[var(--accent)] text-[var(--accent-foreground)] px-5 py-5 shadow-[var(--shadow)]">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-2 opacity-90 text-sm">🔥 Racha {entry.current_streak}</div>
        </div>
